...
Namespace DXExample.Web
	Partial Public Class DXExampleAspNetApplication
		...
		Private reportsAspNetModule1 As DevExpress.ExpressApp.Reports.ReportsModule
		...
		Private Sub InitializeComponent()
			...
			Me.reportsAspNetModule1 = New DevExpress.ExpressApp.Reports.ReportsModule()
			...
			Me.reportsAspNetModule1.ReportDataType = GetType(DXExample.Module.MyReportData)
